...
URL = "https://bliskociebie.inpost.pl/blisko-ciebie/glosuj-na-miejsce#50.768410,20.635270"
...
while True:
    ...
    driver.get(URL)
    driver.find_element_by_id("onetrust-accept-btn-handler")
    driver.find_element_by_class_name('voteButtonValidate').click()
    ...
    if audioBtnFound:
        try:
            while True:
                ...
                driver.find_element_by_id('votePlace').click()
                driver.close()
